...
const Navbar = () => {
  ...
  return (
    <nav className="backdrop-blur-md bg-white/30 border border-white/20 rounded-lg px-8 py-4 shadow-lg">
      <div className="flex justify-between items-center">
        <div className="text-xl font-bold text-pink-400">Logo</div>
